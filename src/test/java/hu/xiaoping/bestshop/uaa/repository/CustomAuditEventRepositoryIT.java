...
import hu.xiaoping.bestshop.uaa.config.audit.AuditEventConverter;
import hu.xiaoping.bestshop.uaa.domain.PersistentAuditEvent;
...
import static hu.xiaoping.bestshop.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
